...
const Achievements = ({
  ...
  const getNextLevel = (achievement) => {
    return (
      achievement.levels.find((level) => level > achievement.progress) ||
  ...
  const getProgress = (achievement) => {
    ...
    const previousLevel =
      achievement.levels[achievement.levels.indexOf(nextLevel) - 1] || 0;
    const progressInCurrentLevel = achievement.progress - previousLevel;
  ...
  return (
    <div className="w-full max-w-md mx-auto fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm">
      {/* Main Navigation Bar */}
      <div className="bg-gradient-to-r from-blue-400 to-green-500 p-2 shadow-lg">
      ...
      {activeTab && (
        <div className="bg-gradient-to-br from-blue-300 via-teal-200 to-green-300 shadow-xl max-h-[calc(100vh-60px)] overflow-y-auto">
          <div className="p-3">
                      ...
                      <div className="mt-1">
                        ...
                        <div className="flex justify-between items-center mt-1">
                          <span className="text-xs text-gray-600">
                            {achievement.progress} / {getNextLevel(achievement)}
                          </span>
                          <span className="text-xs text-gray-600">
                            {Math.round(getProgress(achievement))}%
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-purple-200 rounded-lg overflow-hidden">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 bg-purple-50 hover:bg-purple-100 transition-colors"
                  >
                    <span className="font-medium text-purple-800">Themes</span>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {[
                    ...
                    { name: "Information", icon: <Info className="w-4 h-4" /> },
                  ].map((item, index) => (
                    <button
                      key={index}
